...
Asteroid::Asteroid()
{
    ...
    m_translation.x = ((float) rand() / ((float) RAND_MAX/2.0) - 1.0)/500;
    m_translation.y = ((float) rand() / ((float) RAND_MAX/2.0) - 1.0)/500;
    m_translation.z = ((float) rand() / ((float) RAND_MAX/2.0) - 1.0)/500;
    m_translation.w = 0.0;
